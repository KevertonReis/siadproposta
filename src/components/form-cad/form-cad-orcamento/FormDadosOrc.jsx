        ...
        <div className={styles.divOrc}>
          ...
          {!visible ? (
            ...
            <section>
              ...
              <div className="dadosOrcamento">
                <form
                  onSubmit={handleSubmit}
                  className={styles.formDadosOrcamento}
                >
                  <div className={styles.divTitle}>
                  ...
                  <div className={styles.dadosProposta}>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleChange("vistoriador", e.target.value)
                        }
                        required
                      >
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("qtdeQuadro", e.target.value)
                        }
                        required
                      />
                    </div>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("vigencia", e.target.value)
                        }
                        required
                      />
                    </div>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("valOrcamento", e.target.value)
                        }
                        required
                      />
                    </div>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("valVencedor", e.target.value)
                        }
                        required
                      />
                    </div>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("empVencedor", e.target.value)
                        }
                        required
                      />
                    </div>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("colocacao", e.target.value)
                        }
                        required
                      />
                    </div>
                    ...
                    <div className={styles.itemProposta}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange("codContrato", e.target.value)
                        }
                        required
                      />
                    </div>
